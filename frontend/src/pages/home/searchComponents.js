...
const SearchComponent = () => {
    ...
    return ( 
        <div className="h-screen w-5/6 flex flex-col items-center mt-10 rounded-xl relative">
            ...
            <div className="search-bar h-1/4 w-4/6 bg-primary-white-blue bg-opacity-80 rounded-xl z-2 mt-1/2 transform -translate-y-1/2 relative shadow-xl flex flex-col justify-center items-center">
                ...
                <div id='cover' className='w-5/6 h-1/3 bg-primary-black-blue flex items-center justify-center p-1 mt-4 rounded-md shadow-xl'>
                    <div className="search-area w-full h-5/6 flex items-center justify-center">
                        ...
                        <input type="text" placeholder='Places to go, hotels, restaurants...' className='w-full h-full text-md font-semibold px-2 outline-none shadow-xl rounded-l-md bg-primary-white'/>
