const ContactUs = () => {
    return ( 
        <div className="contact-container flex flex-col items-center h-200">
            ...
            <div className="contact-form w-1/3">
                <form action="" className="flex flex-col justify-center items-left">
                    <label for="name" className="mt-3 font-medium">Name</label>
                    ...
                    <label for="email" className="mt-3 font-medium">Email</label>
                    ...
                    <label for="message" className="mt-3 font-medium">Message</label>
